...
public class JdbcDataWriter extends BaseDataWriter {
    ...
    public JdbcDataWriter(DataTransferConfig config) {
        ...
        batchSize = writerConfig.getParameter().getIntVal(JdbcConfigKeys.KEY_BATCH_SIZE, DEFAULT_BATCH_SIZE);
        ...
        batchFlag = writerConfig.getParameter().getStringVal(KEY_BATCH_FLAG);
    ...
    public DataStreamSink<?> writeData(DataStream<Row> dataSet) {
        ...
        if("Y".equals(batchFlag)){
            ...
            builder.setBatchFlag(batchFlag);
        }
